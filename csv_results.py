                                ...
                                for m_b_d in buf_dim:
                                    for m_t in jolly:
                                        ...
                                        if a=='P' and int(c)==0 and m_t in p_k:
                                            if len(vals[0])>0 and ((a_s=='bigA' and ((n_a=='25' and (m_t=='11' or m_t=='15' or m_t=='17' or m_t=='21' or m_t=='24')) or (n_a=='100' and (m_t=='41' or m_t=='56' or m_t=='65' or m_t=='74' or m_t=='83')))) or (a_s=='smallA' and (n_a=='25' and (m_t=='20' or m_t=='22' or m_t=='23' or m_t=='23.01' or m_t=='24')))):
    ...
    def print_borders(self,path,_type,t_type,ground_T,threshlds,data_in,times_in,keys,more_k):
        ...
        for a in arena:
            ...
            for ag in agents:
                ...
                if row ==1: p_k = [str(20),str(22),str(23),str(23.01),str(24)]
                if int(ag)==100:
